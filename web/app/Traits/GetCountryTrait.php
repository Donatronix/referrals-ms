...
trait GetCountryTrait
{
    ...
    protected array $countries = [
        ...
        ["name" => "Kosovo", "code" => "XK", "phone" => "381", "symbol" => "€", "currency" => "EUR"],
        ...
        ["name" => "Mayotte", "code" => "YT", "phone" => "269", "symbol" => "€", "currency" => "EUR"],
        ...
        ["name" => "Russian Federation", "code" => "RU", "phone" => "70", "symbol" => "₽", "currency" => "RUB"],
        ...
        ["name" => "Sint Maarten", "code" => "SX", "phone" => "1", "symbol" => "ƒ", "currency" => "ANG"],
    ...
    public function getCountry($phoneNumber): string
    {
        $columns = array_column($this->countries, 'phone');
        array_multisort($columns, SORT_DESC, SORT_NUMERIC, $this->countries);
        $country = null;
        foreach ($this->countries as $value) {
            if (str_starts_with($phoneNumber, $value['phone'])) {
                // match
                $country = $value['name'];
                break;
            }
